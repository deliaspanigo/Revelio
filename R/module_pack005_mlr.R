...
module_pack005_mlr_ui <- function(id){
  ...
  div(
    ...
    shiny::h1("Generalized Multiple Linear Regresion - Gamma"),
...
module_pack005_mlr_server <- function(id, vector_all_colnames_database, database){
...
############################
      ...
      input_folder_master <- reactive({
        ...
        selected_folder <- "pack05_mlr"   ### CAMBIO!!!
