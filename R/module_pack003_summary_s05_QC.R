...
module_pack003_summary_s05_QC_ui <- function(id){
...
module_pack003_summary_s05_QC_server <- function(id, vector_all_colnames_database, database){
...
############################
      ...
      input_folder_master <- reactive({
        ...
        selected_folder <- "pack003_summary_05_qc"
