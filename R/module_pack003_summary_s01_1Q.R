...
module_pack003_summary_s01_1Q_ui <- function(id){
...
module_pack003_summary_s01_1Q_server <- function(id, vector_all_colnames_database, database){
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      input_folder_master <- reactive({
        ...
        selected_folder <- "pack003_summary_01_1q"
