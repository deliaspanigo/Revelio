...
### Section 02 of 03 - No correlated groups of x vars
```{r, include =T, eval = T, echo = F, class.source="bg-success"}
...
selected_cols <- colnames(df_ind_cor_models)
new_col_names <- colnames(df_ind_cor_models)
mi_tabla <- df_ind_cor_models
mi_tabla <- mi_tabla[selected_cols]
