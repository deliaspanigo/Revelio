...
#-------------------------------------------------------------------------------
  ...
  vector_name_x_var <- colnames(database)[-1]
  value_name_y <- colnames(database)[1]
...
#-------------------------------------------------------------------------------
  ...
  list_normality_x_01 <- sapply(1:nrow(df_ref_normality_x), function(x){
    ...
    the_test <- shapiro.test(x = minibase[,selected_x_var])
    the_test
...
#-------------------------------------------------------------------------------
  ...
  list_homogeneity01 <- sapply(1:nrow(df_ref_pair), function(x){
    ...
    # The test
    the_test <- bartlett.test(x = list(minibase[,var_x01], minibase[,var_x02]))
    the_test
